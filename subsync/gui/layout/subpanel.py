...
class SubtitlePanel ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.m_buttonSubOpen = wx.BitmapButton( self, wx.ID_OPEN, wx.ArtProvider.GetBitmap( wx.ART_FILE_OPEN, wx.ART_BUTTON ), wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW )
